...
(cl:defmethod cl:initialize-instance :after ((m <DetectLaneFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DetectLaneFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ImageProcess_Node-msg:<DetectLaneFeedback> is deprecated: use ImageProcess_Node-msg:DetectLaneFeedback instead.")))

(cl:ensure-generic-function 'result_image-val :lambda-list '(m))
(cl:defmethod result_image-val ((m <DetectLaneFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ImageProcess_Node-msg:result_image-val is deprecated.  Use ImageProcess_Node-msg:result_image instead.")
  (result_image m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<DetectLaneFeedback>)))
  ...
  "ImageProcess_Node/DetectLaneFeedback")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DetectLaneFeedback)))
  "Returns string type for a message object of type 'DetectLaneFeedback"
  "ImageProcess_Node/DetectLaneFeedback")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<DetectLaneFeedback>)))
  ...
  "b61ace186d489ffe16ffc95be8c5a670")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'DetectLaneFeedback)))
  "Returns md5sum for a message object of type 'DetectLaneFeedback"
  "b61ace186d489ffe16ffc95be8c5a670")
